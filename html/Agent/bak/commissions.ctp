    ...
    <div class="main-content">
        ...
        <div class="panel">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <td>
                        <?=($cur_user['level']=='1'?'销售总监':($cur_user['level']=='2'?'一级代理':($cur_user['level']=='3'?'二级代理':$cur_user['level'])));?></td>
                    <td>
                        <?=$cur_user['bank_num'];?>
                    </td>
                    <td>
        ...
        <div class="panel">
            ...
            <div class="container">
                <form class="form-inline">
                    ...
                    <button onclick="do_withdraw()" type="submit" class="btn btn-primary">申请转投资账户</button>
                </form>
            </div>
        </div>
        <br>
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                  <ul class="nav nav-pills" role="tablist">
                    <li role="presentation" class="active"><a href="#agentCom100" aria-controls="agentCom100" role="tab" data-toggle="tab">佣金分配比例及审批100%</a></li>
                    <li role="presentation"><a href="#agentCom90" aria-controls="agentCom90" role="tab" data-toggle="tab">佣金分配比例及审批90%</a></li>
                  </ul>
                </h4>
            </div>
        ...
        $(function() {
            ...
            $("select", "[name=agentTable]").on('change', function() {
                ...
                let total = a * aC + b * bC + c * cC + d * dC + e * eC + f * fC + g * gC + h * hC;
        ...
        function update_comrate(obj, id) {
            ...
            if (confirm('确认更新佣金比例?')) {
                ...
                $.get('/agent/update_comrate/' + id + '/' + typeA + '/' + typeB + '/' + typeC + '/' + typeD +
        ...
        function do_withdraw() {
            if (confirm('确认转现?')) {
                ...
                $.get('/agent/do_withdraw/' + withdraw_amt, function(ret) {
                    if (ret < 100) {
                        alert('更新成功，即将刷新页面');
                        window.location.reload();
                    } else {
