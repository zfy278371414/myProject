                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="agent_<?=$user['id'];?>" data-user-id="<?=$user['id'];?>">
                            ...
                            <td style="cursor: pointer;color: blue;" onclick="showAgentById('<?=$user['id'];?>','<?=$user['name'];?>');">
                                <?=$user['name'];?>
                            </td>
                            <td>
                            ...
                            <td style="cursor: pointer;color: blue;" onclick="toTradePage('<?=$user['id'];?>');">
                                <?=$user['total_commission'];?>
                            </td>
                            <td style="cursor: pointer;color: blue;" onclick="toWithdrawPage();">
                                <?=$user['commission_get'];?>
                            </td>
                            <td style="cursor: pointer;color: blue;" onclick="toWithdrawPage();">
                                <?=$user['commission_avl'];?>
                            </td>
                            <td style="cursor: pointer;color: blue;" onclick="toProxyUserPage('<?=$user['id'];?>');">
                                <?=$user['agent_count'];?>
                            </td>
                            <td style="cursor: pointer;color: blue;" onclick="toProxyUserPage('<?=$user['id'];?>');">
                                <?=$user['client_count'];?>
...
function getAgentTableTpl(obj, name) {
    ...
    if (obj != null) {
      ...
      <tr>
                ...
                <td>${data['commission_get']}</td>
                <td>${data['commission_avl']}</td>
                <td>${data['agent_count']}</td>
                <td>${data['client_count']}</td>
                <td>${data['total_trading_amt']}</td>
                <td>${data['total_invest_amt']}</td>
            </tr>
      `;
            trs.push(tr);
        }
