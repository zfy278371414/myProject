...
<body>
  ...
  <script type="text/javascript" src="/js/qyjf/common.js?v=25"></script>
  <script>
  // Initialize your app
  var app = new Framework7({
    ...
    routes: [{
      ...
      {
        path:'/search',
        componentUrl:'/pages/get/qyjf_search',
      },
      {
        path:'/edit',
        url:'pages/get/qyjf_edit',
      },
      {
        path: '/tabPage',
        redirect: '/main/tab1'
  ...
  // function setEnableFontUnitToRem(enabled,size){
  //   if(enabled){
  //     var root = document.documentElement;
  //     var rem = root.clientWidth/parseFloat(size)*10;
  //     rem =(rem>=7) ? 7 :rem ;
  //     root.style.fontSize=rem*10+'px';
  //   }
  // }
  // setEnableFontUnitToRem(true,750);
  </script>
</body>
